...
impl KycInputDataDto {
    pub fn new(account_type: AccountType, first_name: String, last_name: String, phone: String, address: models::KycAddress, mail: String) -> KycInputDataDto {
        KycInputDataDto {
            account_type,
            first_name,
            last_name,
