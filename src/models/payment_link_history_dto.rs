...
pub struct PaymentLinkHistoryDto {
    #[serde(rename = "id")]
    pub id: f64,
    ...
    pub payments: Option<Vec<models::PaymentLinkPaymentDto>>,
}

impl PaymentLinkHistoryDto {
    pub fn new(id: f64, route_id: f64, status: Status, url: String, lnurl: String) -> PaymentLinkHistoryDto {
