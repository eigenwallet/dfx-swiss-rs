...
pub struct AssetDetailDto {
    ...
    #[serde(rename = "limits")]
    pub limits: Box<models::AssetLimitsDto>,
}

impl AssetDetailDto {
    pub fn new(id: f64, name: String, unique_name: String, description: String, r#type: Type, category: Category, dex_name: String, fee_tier: FeeTier, coming_soon: bool, buyable: bool, sellable: bool, card_buyable: bool, card_sellable: bool, instant_buyable: bool, instant_sellable: bool, blockchain: Blockchain, limits: models::AssetLimitsDto) -> AssetDetailDto {
        AssetDetailDto {
            id,
            name,
            chain_id: None,
