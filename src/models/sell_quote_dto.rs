...
impl SellQuoteDto {
    pub fn new(fee_amount: f64, amount: f64, estimated_amount: f64, exchange_rate: f64, rate: f64, fees: models::FeeDto, fees_target: models::FeeDto, min_volume: f64, max_volume: f64, min_volume_target: f64, max_volume_target: f64, price_steps: Vec<models::PriceStep>, is_valid: bool) -> SellQuoteDto {
        SellQuoteDto {
            fee_amount,
            amount,
            estimated_amount,
