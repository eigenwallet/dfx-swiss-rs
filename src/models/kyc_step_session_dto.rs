...
pub struct KycStepSessionDto {
    ...
    pub session: Box<models::KycSessionInfoDto>,
}

impl KycStepSessionDto {
    pub fn new(name: Name, status: Status, sequence_number: f64, session: models::KycSessionInfoDto) -> KycStepSessionDto {
        KycStepSessionDto {
            name,
            r#type: None,
            status,
